...
var MSG_SIM_CARD	= '<bean:message key="errors.mandatory" arg0="SIM Card Provider"/>';
var MSG_SERVICE_PROVIDER	= '<bean:message key="errors.mandatory" arg0="M2M Service Provider"/>';
var MSG_LIFE_EQUIP	= '<bean:message key="errors.mandatory" arg0="Projected Use Life of Equipment"/>';
var MSG_M2M_DESCRIBE	= '<bean:message key="errors.mandatory" arg0="Describe the purposes/services and type of information being monitored/transmitted and the intended recipient party (1000 characters)"/>';
...
function isRadioFormEmpty(){
  ...
  var result=true;
   ...
   || !isFieldBlank(frmObj.strRdTxFreq8) || !isFieldBlank(frmObj.strRdRxFreq8) || !isFieldBlank(frmObj.strRdRfOutputPow8)
   || !isFieldBlank(frmObj.strRdTxFreq9) || !isFieldBlank(frmObj.strRdRxFreq9) || !isFieldBlank(frmObj.strRdRfOutputPow9)
   || !isFieldBlank(frmObj.strRdTxFreq10) || !isFieldBlank(frmObj.strRdRxFreq10) || !isFieldBlank(frmObj.strRdRfOutputPow10)
   || !isFieldBlank(frmObj.strRdTxFreq11) || !isFieldBlank(frmObj.strRdRxFreq11) || !isFieldBlank(frmObj.strRdRfOutputPow11)
   || !isFieldBlank(frmObj.strRdTxFreq12) || !isFieldBlank(frmObj.strRdRxFreq12) || !isFieldBlank(frmObj.strRdRfOutputPow12)
   || !isFieldBlank(frmObj.strRdTxFreq13) || !isFieldBlank(frmObj.strRdRxFreq13) || !isFieldBlank(frmObj.strRdRfOutputPow13)
   || !isFieldBlank(frmObj.strRdTxFreq14) || !isFieldBlank(frmObj.strRdRxFreq14) || !isFieldBlank(frmObj.strRdRfOutputPow14)
   || !isFieldBlank(frmObj.strRdTxFreq15) || !isFieldBlank(frmObj.strRdRxFreq15) || !isFieldBlank(frmObj.strRdRfOutputPow15)
...
function validateM2M() {
	var frmObj = document.forms[0];
	if (isFieldBlank(frmObj.strM2mSimCardProvider)) {
		alert(MSG_SIM_CARD);
		return false;
	}
	if (isFieldBlank(frmObj.strM2mServiceProvider)) {
		alert(MSG_SERVICE_PROVIDER);
		return false;
	}
	if (isFieldBlank(frmObj.strM2mLifeEquipment)) {
		alert(MSG_LIFE_EQUIP);
		return false;
	}
	if (isFieldBlank(frmObj.strM2mServiceDescription)) {
		alert(MSG_M2M_DESCRIBE);
		return false;
	}
...
function validateEquipTechLineRadio() {
  ...
  <%
  	boolean equalBothRadioLine = false;
  %>
  
  <logic:equalname="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_LR%>">
  equalBothRadioLine = true;
  </logic:equal>
  <logic:equalname="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_RL%>">
  equalBothRadioLine = true;
  </logic:equal>
  <% if (equalBothRadioLine == true) { %>
  ...
  <logic:notEqual name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_RADIO_IND%>"> 
	 <logic:notEqual name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_LINE_IND%>"> 
	 	<logic:notEqual name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_M2M_IND%>"> 
		    if( countSelectedAppliedFor(formObj) < 0){
	           alert(MSG_EMPTY_EQUIP_TYPE);
		       return false;
	        }
	        if( typeof formObj.strRdLnIndR != 'undefined'
	        		&& formObj.strRdLnIndR.checked){
			 ...
			 if(( (typeof formObj.strRdLnIndR != 'undefined' && !formObj.strRdLnIndR.checked)
					 && (typeof formObj.strRdLnIndL != 'undefined' && !formObj.strRdLnIndL.checked) )
					 || (typeof formObj.strRdLnIndL != 'undefined' && formObj.strRdLnIndL.checked) ){
				 if(!isRadioFormEmpty()){
	        ...
	        if(( (typeof formObj.strRdLnIndR != 'undefined' && !formObj.strRdLnIndR.checked)
					 && (typeof formObj.strRdLnIndL != 'undefined' && !formObj.strRdLnIndL.checked))
					 || (typeof formObj.strRdLnIndR != 'undefined' && formObj.strRdLnIndR.checked) ){
				 if(!isLineFormEmpty()){
	        ...
	        if (typeof formObj.strRdLnIndM != 'undefined' && formObj.strRdLnIndM.checked) {
	        	return validateM2M();
	        }
  ...
  // validation M2M
  <logic:equal name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_M2M_IND%>"> 
	  return validateM2M();
  </logic:equal> 
...
function countSelectedAppliedFor(formObj) {
	if ( typeof formObj.strRdLnIndL != 'undefined'
			&& formObj.strRdLnIndL.checked) {
		return 1;
	}
	if ( typeof formObj.strRdLnIndR != 'undefined'
			&& formObj.strRdLnIndR.checked) {
	...
	if ( typeof formObj.strRdLnIndM != 'undefined'
			&& formObj.strRdLnIndM.checked) {
		return 1;
	}
      ...
      <td valign="top" width="745" > 
        <table border="0" cellspacing="0" width="100%" cellpadding="1">
          ...
          <tr> 
            ...
            <td width="25%">
			  <% String strRdLnInd = "";
			  	strRdLnInd = ((TlsAppTACEquipInfoHdrDTO)request.getAttribute("headerStationDetails")).getStrRdLnInd(); %>
			  <% if (strRdLnInd.length() == 1) {
			  %>
			  	<logic:equal name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_RADIO_IND%>">
				  Radiocom <input type="hidden" name="viewAppTACEquipData" property="strRdLnIndR" value="R">
				</logic:equal>
				<logic:equal name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_LINE_IND%>">
			     Line <input type="hidden" name="viewAppTACEquipData" property="strRdLnIndL" value="L">
			  	</logic:equal>
			  	<logic:equal name="headerStationDetails"  property="strRdLnInd" value="<%=TlsGlobals.LICENCE_TAC_TYPE_M2M_IND%>">
			     M2M <input type="hidden" name="viewAppTACEquipData" property="strRdLnIndM" value="M">
			  	</logic:equal>
			  <% } else {
				  	if (strRdLnInd.contains(TlsGlobals.LICENCE_TAC_TYPE_LINE_IND)) {
			  %>
			  			<html:checkbox name="viewAppTACEquipData" property="strRdLnIndL" value="L">Line</html:checkbox>&nbsp;
			  		<%}
				  	if (strRdLnInd.contains(TlsGlobals.LICENCE_TAC_TYPE_RADIO_IND)) {%>
				  		<html:checkbox name="viewAppTACEquipData" property="strRdLnIndR" value="R">Radiocom</html:checkbox>&nbsp;
				  	<%}
				  	if (strRdLnInd.contains(TlsGlobals.LICENCE_TAC_TYPE_M2M_IND)) {%>
				  		<html:checkbox name="viewAppTACEquipData" property="strRdLnIndM" value="M">M2M</html:checkbox>
				  	<%} %>
			  <% } %>
		  </td>
          </tr>
               ...
               if(idaflag == ""){
                ...
                <tr> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq8" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq8" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow8" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq9" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq9" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow9" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq10" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq10" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow10" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq11" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq11" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow11" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq12" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq12" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow12" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq13" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq13" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow13" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq14" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq14" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow14" size="20" maxlength="20"/>
                  </td>
                </tr>
                <tr> 
                  <td width="20%"   valign="middle" class="h3"> 
                  ...
                  <td width="25%"   valign="middle" class="h3"> 
			        <html:text name="viewAppTACEquipData" property="strRdTxFreq15" size="20" maxlength="30"/>
                  </td>
                  <td width="25%" class="txtLabel"> 
			        <html:text name="viewAppTACEquipData" property="strRdRxFreq15" size="20" maxlength="30"/>
                  </td>
                  <td colspan="2"   valign="middle" class="h3" width="26%"> 
      			    <html:text name="viewAppTACEquipData" property="strRdRfOutputPow15" size="20" maxlength="20"/>
                  </td>
                </tr>
                <!-- 20170821 End -->
                <tr> 
		  ...
		  <tr>
              ...
              <table border="0" cellspacing="0" width="100%" cellpadding="1">
                <tr> 
                  <td colspan="5" height="16" valign="middle" class="heading">Equipment Technical Data - M2M</td>
                </tr>
				<tr>
                	<td width="26%" height="16" valign="middle" class="h3">SIM Card Provider<tls:asterisk/></td>
					<td width="29%" class="txtLabel"> 
					  <html:text name="viewAppTACEquipData" property="strM2mSimCardProvider" size="20" maxlength="60" />
					</td>
					<td width="20%" height="16" valign="middle" class="h3">Projected Use Life of Equipment (in number of years)<tls:asterisk/></td>
					<td width="25%" class="bodyText"> 
					  <html:text name="viewAppTACEquipData" property="strM2mLifeEquipment" size="20" maxlength="2" />
					</td>
				</tr>
				<tr>
                	<td width="26%" height="16" valign="middle" class="h3">M2M Service Provider<tls:asterisk/></td>
					<td width="29%" class="bodyText"> 
					  <html:text name="viewAppTACEquipData" property="strM2mServiceProvider" size="20" maxlength="60" />
					</td>
				</tr>
				<tr>
					<td width="26%" height="16" valign="middle" class="h3">
						Describe the purposes/services and type 
						of information being monitored/transmitted and the intended recipient party (1000 characters)<tls:asterisk/>
					</td>
					<td colspan="3" height="59" valign="middle" class="txtLabel">
						<html:textarea cols="60" rows="6" name="viewAppTACEquipData" property="strM2mServiceDescription" 
					      onkeyup="checkLength(this,1000)" style="vertical-align: top;">
					  	</html:textarea>
					</td>
				</tr>
               </table>
